...
Init: `s[0]='2'≠'0'` → `prev2=1` (=dp[0]), `prev1=1` (=dp[1]).

| i | s[i-1] | 1-digit → +prev1 | s[i-2:i] | 2-digit → +prev2 | curr | (prev2, prev1) after |
|---|--------|------------------|----------|------------------|------|----------------------|
| 2 | '2'≠0  | +1               | 22∈[10,26] | +1             | 2    | (1, 2)               |
| 3 | '6'≠0  | +2               | 26∈[10,26] | +1             | 3    | (2, 3)               |
